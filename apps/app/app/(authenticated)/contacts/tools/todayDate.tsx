...
function getTodaysDate(
  format: "locale" | "iso" | "readable" | "short" = "locale"
): string {
...
export const todayDateTool: ReturnType<ReturnType<typeof defineAiTool>> =
  defineAiTool()({
    description:
      "Get today's date in various formats. No parameters needed - simply call this tool to get today's date.",
    parameters: {
    ...
    execute: async () => {
      const date = await getTodaysDate("readable");
      const details = await getTodaysDateDetails();
